...
final class UglyHacks {
    ...
    static boolean shouldSkipMessage(Object item) {
        ...
        if (sourceRecord.value() == null) {
            // When deleting an entry then I can see Debezium emits 2 items:
            // 1. item with value set to null
            // 2. actual item with the deleted entry
            // I am not sure why there is #1 so skipping for now
            return true;
        }
